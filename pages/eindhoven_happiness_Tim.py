...
def app():
    ...
    smileys_replaced["Happiness rank"] = smileys_replaced["PctUnemployed"].replace("N/A", pd.NA)
    smileys_replaced["Happiness rank"] = smileys_replaced["PctHighEducation"].replace("N/A", pd.NA)
